    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                ...
                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="{{ route('welcome.index') }}">Home</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded" href="{{ route('welcome.pakettravel') }}">Paket Travel</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1">
